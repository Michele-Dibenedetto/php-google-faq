...
<body>
        ...
        $faqs= [
            ...
            "faq_3" => [
                ...
                "nested answer" => [
                    ...
                    "nestred answer" => [
                        "answer" => "Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.",
                        "answer" =>"Google LLC, con sede negli Stati Uniti, per il resto del mondo."
                    ],
    ...
    <header>
        ...
        <div class="head_top">
                <img class="logo" src="img\google-1.png" alt="">
    ...
    <main>
        <?php foreach ($faqs as $faq => $element) { ?>
            <div class="faq">
                <h2><?php echo $element["question"] ?></h2>
                <p><?php echo $element["answer"] ?></p>
                <?php foreach ($element["list answers"] as $value) { ?> 
                    <p><?php echo $value ?></p>
                <?php } ?>
            </div>
        <?php } ?>
